...
template <class CharT>
class basic_null_json_input_handler : public basic_jcr_input_handler<CharT>
{
public:
...
typedef basic_jcr_input_handler<char> json_input_handler;
typedef basic_jcr_input_handler<wchar_t> wjson_input_handler;
