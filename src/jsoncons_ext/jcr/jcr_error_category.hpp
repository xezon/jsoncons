...
public:
    ...
    virtual std::string message(int ev) const
    {
        ...
        case jcr_parser_errc::expected_u8_found_u16:
            return "Expected UTF-8, found UTF-16";
        case jcr_parser_errc::expected_u8_found_u32:
            return "Expected UTF-8, found UTF-32";
        case jcr_parser_errc::expected_u16_found_fffe:
            return "Expected UTF-16, found non character";
        case jcr_parser_errc::expected_u32_found_fffe:
...
{
    return std::error_code(static_cast<int>(result), jcr_error_category());
}
