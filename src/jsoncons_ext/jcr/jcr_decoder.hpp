...
#ifndef JSONCONS_JCR_JCR_DECODER_HPP
#define JSONCONS_JCR_JCR_DECODER_HPP
...
template <class Json>
class jcr_decoder : public basic_jcr_input_handler<typename Json::char_type>
{
public:
    typedef typename Json::char_type char_type;
    using typename basic_jcr_input_handler<char_type>::string_view_type;
...
public:
    jcr_decoder(const char_allocator& sa = char_allocator(),
