...
#ifndef JSONCONS_JCR_JCR_READER_HPP
#define JSONCONS_JCR_JCR_READER_HPP
...
class basic_jcr_reader 
{
    ...
    size_t index_;
public:
    basic_jcr_reader(std::basic_istream<CharT>& is,
...
typedef basic_jcr_reader<char> json_reader;
typedef basic_jcr_reader<wchar_t> wjson_reader;
